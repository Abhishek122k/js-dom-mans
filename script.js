...
containerElement.style.backgroundColor = "aqua";
...
const domMethods1Elements = document.getElementsByClassName("dom-methods");
for (let i = 0; i < domMethods1Elements.length; i++) {
    domMethods1Elements[i].style.color = "red";
    domMethods1Elements[i].style.fontSize = "20px";
}
